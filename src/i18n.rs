    ...
    pub fn text(self) -> Text {
        match self {
            ...
            Language::En => Text {
                ...
                mode_game: "Game",
                hint_label: "Note",
                hint_value: "exclusive: borderless",
                layout: "Layout",
                vertical: "Vertical",
...
pub struct Text {
    ...
    pub mode: &'static str,
    pub mode_desktop: &'static str,
    pub mode_game: &'static str,
    /// Notice shown while (and after) a game holds the display exclusively.
    pub hint_label: &'static str,
    pub hint_value: &'static str,
